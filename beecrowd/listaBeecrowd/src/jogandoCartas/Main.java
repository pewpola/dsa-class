...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            printDiscardedAndRemainingCards(n);
    ...
    public static void printDiscardedAndRemainingCards(int n) {
        ...
        System.out.println("Remaining card: " + list.top());
    }
}
